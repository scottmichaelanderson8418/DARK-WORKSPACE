...
public class SecurityConfiguration {
	...
	//
	// UserDetails normalUser = User.builder().username("gc").password("123").roles("USER").build();
	// UserDetails adminUser = User.builder().username("admin").password("123").roles("ADMIN", "USER").build();
