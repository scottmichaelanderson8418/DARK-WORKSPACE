...
public class ContentController {
	...
	public String handleLogin() {
		...
		System.out.println("\nEntering custom_login.html---------GET");
	...
	public String handleUpdateUser(Model model) {
		...
		System.out.println("\nEntering /admin/updateuser    GET METHOD.html-------");

		return "update_user";
	}

	@PostMapping("/admin/updateuser")
	public String handleUpdateUser(@ModelAttribute MyUser myUser, Model model) {
		System.out.println("\nEntering /admin/updateuser   POST METHOD.html-------");
		System.out.println("Username : " + myUser.getUsername());
