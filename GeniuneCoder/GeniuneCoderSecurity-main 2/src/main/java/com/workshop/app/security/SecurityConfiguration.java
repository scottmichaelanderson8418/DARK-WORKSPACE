...
import com.workshop.app.auth.AuthenticationSuccessHandler;
...
public class SecurityConfiguration {
	...
	// MyUserDetailService contains the details of the user's username and password
	// from the database
	@Autowired
	...
	// This is a data access object--> created for loading users from the database
	// --> it is also used for
	// authentication
	@Bean
	...
	// @Bean
	// AuthenticationSuccessHandler authenticat¨ionSuccessHandler;
