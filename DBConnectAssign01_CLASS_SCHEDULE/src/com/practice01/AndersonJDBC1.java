...
public class AndersonJDBC1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Connection conn = DriverManager.getConnection(
					"jdbc:postgresql://localhost:5432/ClassSchedule", "postgres", "five2one");
	...
	public static void dropTable(Connection conn) {
		...
		System.out
				.println("Checking for existing ClassSchedule table in the ClassSchedule Database");
	...
	public static void displayAllRows(Connection conn) {
		...
		try {
			...
			// table of data usually made by executing a statement that queries the database
			ResultSet result = getResultSet(conn);

			// An object that can be used to return the type and properties of the object
