...
public class TaskManager {
	...
	// FIXED: what should I do to make the Task Manager accept any list ? 
	// private static  List<Task> tasks = new ArrayList<>();
	private static  List<Task> tasks = null;
	
	// New method..must be the first method to call...
	public static void initialize(final List<Task> tasks) throws Exception {
		if (tasks == null ) throw new Exception (Constants.NULL_TASK_LIST_MESSAGE);
		TaskManager.tasks = tasks;
	}
	
	// Add Task
	public static void addTask(final Scanner scanner) throws Exception  {
	...
	// Remove Task
	public static void removeTask(final Scanner scanner) throws Exception  {
	...
	// Complete Task...
	public static void completeTask(final Scanner scanner) throws Exception {
